  ...
  return (
    ...
    >
      <Link
        ...
        className="block w-full aspect-video bg-muted relative rounded-[var(--radius)] overflow-hidden group focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-offset-2 focus-visible:ring-offset-background outline-none"
      >
        <Image
          src={imgSrc}
      ...
      <div className="mt-6">
        ...
        <Reveal>
          <p className="text-muted-foreground leading-relaxed subheading">
            ...
            <Link
              href={detailHref}
              className="inline-block text-sm text-foreground hover:text-muted-foreground transition-colors duration-300 underline underline-offset-2"
            >
              Learn more
            </Link>
          </p>
